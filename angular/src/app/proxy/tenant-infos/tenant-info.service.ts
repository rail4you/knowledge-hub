import type { CreateUpdateTenantInfoDto, TenantInfoDto, TenantInfoListItemDto, TenantKnowledgeGraphDto } from './dtos/models';
...
export class TenantInfoService {
  ...
  getList = (config?: Partial<Rest.Config>) =>
    this.restService.request<any, TenantInfoListItemDto[]>({
      method: 'GET',
      url: '/api/app/tenant-info',
    },
    { apiName: this.apiName,...config });
