...
{
    /// <summary>
    /// P2-4：新增 ChapterExercise 多对多关联表，让同一道题目可被复用到多个章节。
    /// 同时回填已有 Exercise.ChapterId 到 ChapterExercise，保证数据一致。
    /// </summary>
    public partial class AddChapterExerciseJoinTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // 唯一约束：同一 (ChapterId, ExerciseId) 不重复加入
            migrationBuilder.CreateIndex(
